...
class test_Triangles_Activity : AppCompatActivity() {

    companion object {
        val TAG = "test_Triangles_Activity"
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_test__triangles)
        title = "基本三角形(test_Triangles_Activity)"

        glSurfaceView.setEGLContextClientVersion(3)

        var render = TrianglesRenderer(applicationContext)
