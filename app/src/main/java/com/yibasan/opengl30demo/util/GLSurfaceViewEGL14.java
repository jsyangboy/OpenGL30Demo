...
public class GLSurfaceViewEGL14 extends SurfaceView implements SurfaceHolder.Callback2 {
    ...
    private static class EglHelper {
        ...
        private WeakReference<GLSurfaceViewEGL14> mGLSurfaceViewEGL14WeakRef;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<GLSurfaceViewEGL14> GLSurfaceViewEGL14WeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
        ...
        private void guardedRun() throws InterruptedException {
            mEglHelper = new EglHelper(mGLSurfaceViewEGL14WeakRef);
            mHaveEglContext = false;
            mHaveEglSurface = false;
            mWantRenderNotification = false;
...
//                    }
         ...
         * called. This weak reference allows the GLSurfaceViewEGL14 to be garbage collected while
    ...
    static class LogWriter extends Writer {
        ...
        private void flushBuilder() {
            if (mBuilder.length() > 0) {
                Log.v("GLSurfaceViewEGL14", mBuilder.toString());
    ...
    private final WeakReference<GLSurfaceViewEGL14> mThisWeakRef =
            new WeakReference<GLSurfaceViewEGL14>(this);
